...
public class CarRenewController {
    ...
    public AjaxResult list(@RequestParam(value = "page",defaultValue = "1") int page,
                           ...
                           CarRenewOrder carRenewOrder){
        AjaxResult ajaxResult = new AjaxResult();
        if(StringUtils.isNotBlank(carRenewOrder.getEndDate())){
            carRenewOrder.setEndDate(carRenewOrder.getEndDate() + " 23:59:59");
        }
